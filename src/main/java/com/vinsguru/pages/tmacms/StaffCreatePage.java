...
public class StaffCreatePage extends BaseCreatePage {
    private static final Logger log = LoggerFactory.getLogger(StaffCreatePage.class);
    ...
    public StaffCreatePage(WebDriver driver) {
        super(driver, "staffs", "create");
